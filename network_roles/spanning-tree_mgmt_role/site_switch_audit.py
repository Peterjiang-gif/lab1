...
vlan_access_collect=[]
vlan_trunk_collect=[]
filewrite=open('vlan_ports_detail.txt','a')
for i in range(0,3):
     device_name=i
     trunk_int=[]
     port_channel=[]
     ...
     trunk_config_port=[]
     access_up_port=[]
     with open('siteswitch_csw_vlan_brief.txt','r') as output:   
       vlan_id=""
       vlan_port=""     
       for line in output:
     ...
     start_flag="false" 
     with open('siteswitch_switch_int_config.txt','r') as output:
        for line in output: 
            if start_flag=="ture":
       ...
       if len(record)>int(1) and record[0]!="": 
          ...
          if ',' in record[1]:
             ...
             for k in range (0,L):
                 ...
                 with open ('siteswitch_switch_interface_status.txt','r') as out:
                      for queue in out:
                          if info[k] in queue:
                             result=queue.split()
                             if len(result)>int(4):
...
filewrite.write("\n")
filewrite.write("note: 0 represent m-anz-vic-833csm-fg-la-a-s01, 1 represent m-anz-vic-833csm-fg-la-a-s02, 2 represent m-anz-vic-833csm-fg-la-a-s03 ")
filewrite.write("\n")
filewrite.write("vlans access ports:")
filewrite.write("\n") 
for i in range(0,len(vlan_access_collect)): 
    filewrite.write(vlan_access_collect[i])   
    filewrite.write("\n")  
filewrite.write("\n") 
filewrite.write("vlans trunk ports:")
filewrite.write("\n") 
for i in range(0,len(vlan_trunk_collect)): 
    filewrite.write(vlan_trunk_collect[i])   
    filewrite.write("\n")   
filewrite.close()    
#print("vlan collect information:") 
#print("note: 0 represent m-anz-vic-833csm-fg-la-a-s01, 1 represent m-anz-vic-833csm-fg-la-a-s02, 2 represent m-anz-vic-833csm-fg-la-a-s03 ")
#print("vlans access ports:")
#print('\n')    
#print(vlan_access_collect)
#print('\n')
#print('\n')
#print('\n')
#print('\n')
#print("vlans trunk ports:")
#print('\n')
#print(vlan_trunk_collect)